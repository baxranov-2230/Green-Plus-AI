...
import { Menu, Bell, Search, User, Moon, Sun, Sparkles } from 'lucide-react';
  ...
  return (
    <header className="h-16 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 sticky top-0 z-30 flex items-center justify-between px-4 sm:px-6 lg:px-8 shadow-sm transition-all duration-300">
      ...
      <div className="flex items-center gap-3 sm:gap-5">
        ...
        {/* Enhanced Creative Dark Mode Toggle */}
        <button 
        ...
        >
          ...
          <div className={`absolute inset-0 opacity-20 blur-xl transition-colors duration-500 ${isDarkMode ? 'bg-indigo-500' : 'bg-emerald-400'}`}></div>
        </button>
